...
import { ProductCatalogExportImportModal } from './ProductCatalogExportImportModal';

export const ProductsView: React.FC = () => {
  const { products, addProduct, updateProduct, deleteProduct, activeCompany } = useApp();
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Cadastre os itens que compõem as cestas básicas desta empresa com custos unitários e estoque.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white hover:bg-slate-50 border border-slate-300 text-slate-700 font-semibold rounded-lg text-xs sm:text-sm shadow-2xs transition-colors cursor-pointer"
            title="Exportar catálogo, importar JSON ou clonar produtos de outra empresa"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold rounded-lg text-xs sm:text-sm shadow-xs transition-colors cursor-pointer"
          >
      ...
      {/* Product Catalog Export / Import / Clone Modal */}
